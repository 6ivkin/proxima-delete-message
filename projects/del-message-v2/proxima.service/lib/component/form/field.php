...
abstract class Field implements FieldInterface
{
    ...
    public static function create(array $data): ?Field
    {
        ...
        $className = '\\Proxima\\Service\\Component\\Form\\' . $fieldType . 'Field';
    ...
    {
        return is_array($this->options['class']) ? $this->options['class'] : [];
    }
    ...
    {
        return implode(' ', $this->getCssClass());
    }
    ...
    {
        return is_array($this->options['data']) ? $this->options['data'] : [];
    }
    ...
    public function getDataString(): string
    {
        ...
        foreach ($this->getData() as $key => $value) {
            $items[] = 'data-' . htmlspecialchars($key) . '="' . htmlspecialchars($value) . '"';
        }
